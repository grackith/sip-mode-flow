...
<div style="display: flex; flex-direction: row;">
    <img src="sips-filtered-manbr.png?raw=TRUE" alt="Figure 1: Vision Zero Street Improvement Projects (since 2014)" title="Figure 1: Vision Zero Street Improvement Projects (since 2014)" style="width: 33%;">
    <img src="traffic-viewer.png?raw=TRUE" alt="Figure 2: Traffic Viewer of Manhattan and Brooklyn" title="Figure 2: Traffic Viewer of Manhattan and Brooklyn" style="width: 33%;">
    <img src="traffic-viewer-includes-speed.png?raw=TRUE" alt="Figure 3: Traffic Viewer locations that include speed" title="Figure 3: Traffic Viewer locations that include speed" style="width: 33%;">
</div>
...
![MFG framework](mfg-framework.png?raw=TRUE "Figure 3: Manheim, Florian, and Gaudry Framework")
